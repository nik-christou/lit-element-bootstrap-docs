...
class SlidesWithIndicatorsExample extends BsExampleMixin(LitElement) {
...
window.customElements.define('slides-with-indicators-example', SlidesWithIndicatorsExample);
...
class BsBadge extends LitElement {
  static get styles() {
    return [BsContentRebootCss, BsBadgeCss];
  }
...
class BsBadgeLink extends LitElement {
  ...
  static get styles() {
    return [BsContentRebootCss, BsBadgeCss, BsBadgeLinkCss];
  }
...
export { BsBadge, BsBadgeCss, BsBadgeLink, BsBadgeLinkCss };

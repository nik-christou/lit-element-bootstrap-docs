...
class BsInputGroup extends LitElement {
  ...
  static get styles() {
    return [BsContentRebootCss, BsInputGroupCss, BsInputGroupLargeCss, BsInputGroupSmallCss];
  }
  ...
  _isCustomFileElement(element) {
    if (element) {
      return element.nodeType === Node.ELEMENT_NODE && element.localName === 'bs-custom-file';
    }
  }

  _isCustomSelectElement(element) {
    if (element) {
      return element.nodeType === Node.ELEMENT_NODE && element.localName === 'bs-custom-select';
    }
  }
...
class BsInputGroupText extends LitElement {
  static get styles() {
    return [BsContentRebootCss, BsInputGroupTextCss];
  }
...
const BsInputGroupAppendCss = css`
...
class BsInputGroupAppend extends LitElement {
  static get styles() {
    return [BsContentRebootCss, BsInputGroupAppendCss];
  }
  ...
  _isInputGroupTextElement(element) {
    if (element) {
      return element.nodeType === Node.ELEMENT_NODE && element.localName === 'bs-input-group-text';
    }
  }

  _isDropdownElement(element) {
    if (element) {
      return element.nodeType === Node.ELEMENT_NODE && element.localName === 'bs-dropdown';
    }
  }
...
const BsInputGroupPrependCss = css`
...
class BsInputGroupPrepend extends LitElement {
  static get styles() {
    return [BsContentRebootCss, BsInputGroupPrependCss];
  }
...
export { BsInputGroup, BsInputGroupAppend, BsInputGroupAppendCss, BsInputGroupCss, BsInputGroupLargeCss, BsInputGroupPrepend, BsInputGroupPrependCss, BsInputGroupSmallCss, BsInputGroupText, BsInputGroupTextCss };

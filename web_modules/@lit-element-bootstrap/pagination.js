...
class BsPageItem extends LitElement {
  ...
  static get styles() {
    return [BsContentRebootCss, BsPageItemCss];
  }
...
class BsPageLink extends LitElement {
  ...
  static get styles() {
    return [BsContentRebootCss, BsPageLinkCss];
  }
...
class BsPagination extends LitElement {
  ...
  static get styles() {
    return [BsContentRebootCss, BsPaginationCss];
  }
...
export { BsPageItem, BsPageItemCss, BsPageLink, BsPageLinkCss, BsPagination, BsPaginationCss };

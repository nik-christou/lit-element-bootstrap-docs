...
class BsModal extends LitElement {
  static get styles() {
    return [BsContentRebootCss, BsModalCss];
  }
...
class BsModalBody extends LitElement {
  static get styles() {
    return [BsContentRebootCss, BsModalBodyCss];
  }
...
class BsModalFooter extends LitElement {
  static get styles() {
    return [BsContentRebootCss, BsModalFooterCss];
  }
...
class BsModalHeader extends LitElement {
  static get styles() {
    return [BsContentRebootCss, BsModalHeaderCss];
  }
...
export { BsModal, BsModalBody, BsModalBodyCss, BsModalCss, BsModalFooter, BsModalFooterCss, BsModalHeader, BsModalHeaderCss };

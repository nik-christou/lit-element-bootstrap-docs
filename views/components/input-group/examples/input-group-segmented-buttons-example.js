...
class InputGroupSegmentedButtonsExample extends LitElement {
            ...
            <bs-example>
                ...
                <bs-input-group class="mb-3">
                    <bs-input-group-prepend>
                        <bs-dropdown split> 
                            <bs-button outline-secondary>Action</bs-button>
                            <bs-button outline-secondary dropdown-toggle></bs-button>
...
<span class="nt">&lt;bs-input-group</span> <span class="na">class=</span><span class="s">"mb-3"</span><span class="nt">&gt;</span>
    <span class="nt">&lt;bs-input-group-prepend&gt;</span>
        <span class="nt">&lt;bs-dropdown</span> <span class="na">split</span><span class="nt">&gt;</span>
            <span class="nt">&lt;bs-button</span> <span class="na">outline-secondary</span><span class="nt">&gt;</span>Action<span class="nt">&lt;/bs-button&gt;</span>
            <span class="nt">&lt;bs-button</span> <span class="na">outline-secondary</span> <span class="na">dropdown-toggle</span> <span class="na">dropdown-toggle-split</span><span class="nt">&gt;</span><span class="nt">&lt;/bs-button&gt;</span>
...
<span class="nt">&lt;bs-input-group</span> <span class="na">class=</span><span class="s">"mb-3"</span><span class="nt">&gt;</span>
    ...
    <span class="nt">&lt;bs-input-group-append&gt;</span>
        <span class="nt">&lt;bs-dropdown</span> <span class="na">split</span><span class="nt">&gt;</span>
            <span class="nt">&lt;bs-button</span> <span class="na">outline-secondary</span> <span class="na">dropdown-toggle</span><span class="nt">&gt;</span><span class="nt">&lt;/bs-button&gt;</span>
            <span class="nt">&lt;bs-button</span> <span class="na">outline-secondary</span><span class="nt">&gt;</span>Action<span class="nt">&lt;/bs-button&gt;</span>
            <span class="nt">&lt;bs-dropdown-menu</span> <span class="na">down</span> <span class="na">x-placement=</span><span class="s">"bottom-start"</span><span class="nt">&gt;</span>
                <span class="nt">&lt;bs-dropdown-item-link</span> <span class="na">title=</span><span class="s">"Action"</span> <span class="na">index=</span><span class="s">"0"</span><span class="nt">&gt;</span><span class="nt">&lt;/bs-dropdown-item-link&gt;</span>
                <span class="nt">&lt;bs-dropdown-item-link</span> <span class="na">title=</span><span class="s">"Another action"</span> <span class="na">index=</span><span class="s">"1"</span><span class="nt">&gt;</span><span class="nt">&lt;/bs-dropdown-item-link&gt;</span>
...
window.customElements.define('input-group-segmented-buttons-example', InputGroupSegmentedButtonsExample);
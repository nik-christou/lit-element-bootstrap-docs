...
class SlidesWithCrossfadeExample extends LitElement {
    ...
    render() {
        return html`
            ...
            <bs-highlight>
                <pre><code class="language-html" data-lang="html"><span class="nt">&lt;bs-carousel</span> <span class="na">fade</span><span class="nt">&gt;</span>
...
window.customElements.define('slides-with-crossfade-example', SlidesWithCrossfadeExample);